...
export const Hero = () => {
  return (
    <div className="w-full py-5 4xl:py-[2.5rem] 2xl:py-[1.5rem] lg:p-[7.5rem] px-4 4xl:px-[7.5rem] 2xl:px-[6.5rem] hero-div">
      <div className="flex flex-col gap-8 items-start justify-center">
        <div className="flex flex-col gap-4 self-stretch">
          <p className="text-[#191919] text-[4rem] font-bold tracking-[0.032rem]">
